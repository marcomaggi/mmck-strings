...
(declare (unit mmck.strings)
	 (uses mmck.strings.core)
	 (uses mmck.strings.version)
	 (emit-import-library mmck.strings))

(module (mmck.strings)
    ()
  (import (only (chicken module) reexport))
  (reexport (mmck.strings.core))
  (reexport (mmck.strings.version))
  #| end of module |# )
